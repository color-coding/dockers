...
目标：
  ...
  webtop-ibas-ubuntu-21 colorcoding/webtop:ibas-ubuntu-21
EOF
}
...
valid_target() {
  case "$1" in
    ibas-alpine|ibas-ubi-minimal-v2|webtop-ibas-ubuntu|webtop-ibas-ubuntu-21) return 0 ;;
    *) return 1 ;;
  esac
}
...
build_target webtop-ibas-ubuntu-21 dockerfile-vscode-eclipse-21 colorcoding/webtop:ibas-ubuntu-21
END_SECONDS=$(date +%s)
