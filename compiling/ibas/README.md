...
cd ./compiling
./builds.sh
./builds.sh --only ibas-alpine,ibas-ubi-minimal-v2,webtop-ibas-ubuntu-21
...
~~~
* webtop:ibas-ubuntu-21

仅支持 amd64 架构。
~~~
docker build -f ./dockerfile-vscode-eclipse-21 -t colorcoding/webtop:ibas-ubuntu-21 ./
~~~
...
* webtop:ibas-ubuntu
~~~
docker run -d -p 80:5901 colorcoding/webtop:ibas-ubuntu
~~~
* webtop:ibas-ubuntu-21
~~~
docker run -d -p 80:5901 colorcoding/webtop:ibas-ubuntu-21
~~~
